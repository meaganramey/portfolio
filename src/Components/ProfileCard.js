...
const ProfileCard = (props) => {
  return (
    <>
      <Card style={{ width: "18rem" }} text="secondary">
        ...
        <Card.Body>
          ...
          >
            ...
            <br />608-208-6758
            <br />
            GitHub: <a href="https://github.com/meaganramey" target='_blank' rel="noreferrer">
             Meagan Ramey
              <br />
            </a>
            <a href="https://www.linkedin.com/in/meagan-ramey/" target='_blank' rel="noreferrer">
              LinkedIn
            </a>
          </Card.Text>
